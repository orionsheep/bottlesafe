...
import { emptyProfile, loadProfile, selectedLabels, toApiContext, type HouseholdProfile } from "../profile";
...
export default function Assistant() {
  ...
  const ask = async (q: string) => {
    ...
    try {
      ...
      setMessages([...next, { role: "assistant", content: data.answer, meta: { graph: data.graph, related_items: data.related_items } }]);
    } catch {
